 ...
 * ---------------------------
 * method：get
 * url:"http://localhost:3000/api/v2.1/article/get?id=id1"
 * 单个：　id='id1'
 ...
 * ---------------------------
 * method：get
 * url:"http://localhost:3000/api/v2.1/article/list?page=1&rows=10"
 * page:当前页
 * rows:每页取多少条
 ...
 * ---------------------------
 * method：post
 * url:"http://localhost:3000/api/v2.1/article/remove"
 * 单个：　data:{id:'id1'}
 ...
 * ---------------------------
 * method：post
 * url:"http://localhost:3000/api/v2.1/article/create"
